...
from model.crowdsourcing.rpn_aggregation_layer import _RPNAggregationLayer
...
class _RPN(nn.Module):
    ...
    def __init__(self, din, classes, n_classes):
        ...
        self.RPN_aggregation = _RPNAggregationLayer(self.feat_stride, self.anchor_scales, self.anchor_ratios,
    ...
    def forward(self, base_feat, im_info, gt_boxes, num_boxes, crowdsourced_classes=None, alpha_con=None):
        ...
        if self.training:
            ...
            if self.label_source == 2:
                gt_boxes = self.RPN_aggregation((rpn_cls_prob.data, gt_boxes, num_boxes, im_info, crowdsourced_classes, alpha_con))
